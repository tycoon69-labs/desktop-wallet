export default {
  ...
  INTRODUCTION: {
    ...
    DUTY: {
      ...
      WARNING: {
        ...
        CANNOT_RESTORE: 'Senhas perdidas, senhas ou fundos roubados não podem ser restaurados pelos delegados, pela equipe do tycoonchain.com ou por qualquer outra pessoa'
      },
    ...
    RESPONSIBILITY: {
      ...
      STORAGE: {
        EXPLANATION: 'A {PASSPHRASE} de cada endereço da carteira é capaz de assinar transações e movimentar fundos. Isso significa que, se seu computador morrer, mas você tiver sua frase secreta, ainda poderá acessar seus fundos. A T69 Desktop Wallet tem um recurso adicional que permite definir um {ENCRYPTED} também, para facilitar o gerenciamento. Se o seu computador morrer, você não poderá usar a senha criptografada para acessar seus fundos de uma máquina diferente. {NEED}.',
      ...
      BACKUP: {
        ...
        OPTIONS: 'Você pode anotá-lo em papel e armazenar várias cópias em locais seguros. Você também pode armazená-lo em uma unidade flash criptografada. Alternativamente, você pode usar um dispositivo de hardware USB Ledger Nano S, disponível em Ledger.com, para armazenar e acessar seus fundos e a Carteira Desktop T69. Você pode conectar seu Ledger Nano S ao seu computador e acessar o blockchain T69 sem precisar digitar sua frase secreta..'
      },
    ...
    TURN: {
      TITLE: 'Your Turn',
      KNOWLEDGE: 'Agora, armado com o conhecimento de como é importante manter suas senhas seguras, você está pronto para reivindicar sua autonomia financeira com o T69 Desktop Wallet.',
      SUPPORT: 'O T69 é um ecossistema de código aberto e, se precisar de ajuda, a comunidade e a equipe da T69 estão aqui para ajudar. Crie um post no reddit.t69.io, ou entre no chat em tempo real no slack.t69.io.',
      CONCLUSION: 'Todos aqui na equipe tycoonchain.com esperam que você goste de usar a T69 Desktop Wallet para participar da revolução blockchain!'
    }
  },
  ...
  PAGES: {
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE: 'Compre {ticker} diretamente dentro da T69 Desktop Wallet com a nossa integração com o Changelly',
  ...
  WALLET_DELEGATES: {
    ...
    EXPLANATION: 'A votação é um mecanismo opcional, mas importante, que mantém a rede da T69 segura. Os 51 delegados com mais votos da rede são responsáveis por verificar e forjar transações em novos blocos. Esta página pode ser usada para votar em um delegado que você apóia. Saiba mais sobre como votar em um delegado clicando no link a seguir:',
